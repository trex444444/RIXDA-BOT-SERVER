...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('activity-chess')
    .setDescription('Start Chess in the Park in a voice channel')
  ...
  async execute(interaction) {
    ...
    try {
      const invite = await voiceChannel.createInvite({ targetType: 2, targetApplication: '832012774040141894', maxAge: 86400 });
