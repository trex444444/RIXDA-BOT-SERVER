...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('activity-checkers')
    .setDescription('Start Checkers in the Park in a voice channel')
  ...
  async execute(interaction) {
    ...
    try {
      const invite = await voiceChannel.createInvite({ targetType: 2, targetApplication: '832013003968348200', maxAge: 86400 });
