...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('activity-landio')
    .setDescription('Start Land-io in a voice channel')
  ...
  async execute(interaction) {
    ...
    try {
      const invite = await voiceChannel.createInvite({ targetType: 2, targetApplication: '903769130790969345', maxAge: 86400 });
