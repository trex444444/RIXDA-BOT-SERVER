...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('activity-youtube')
    .setDescription('Start Watch Together in a voice channel')
  ...
  async execute(interaction) {
    ...
    try {
      const invite = await voiceChannel.createInvite({ targetType: 2, targetApplication: '880218394199220334', maxAge: 86400 });
