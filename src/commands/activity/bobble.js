...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('activity-bobble')
    .setDescription('Start Bobble League in a voice channel')
  ...
  async execute(interaction) {
    ...
    try {
      const invite = await voiceChannel.createInvite({ targetType: 2, targetApplication: '947957217959759964', maxAge: 86400 });
      const embed = new EmbedBuilder()
        .setTitle('🎮 Bobble League')
