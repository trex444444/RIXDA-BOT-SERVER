...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('activity-spellcast')
    .setDescription('Start SpellCast in a voice channel')
  ...
  async execute(interaction) {
    ...
    try {
      const invite = await voiceChannel.createInvite({ targetType: 2, targetApplication: '852509694341283871', maxAge: 86400 });
